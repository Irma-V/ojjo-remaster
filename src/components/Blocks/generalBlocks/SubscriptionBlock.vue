        ...
        <div class="content">
            <div class="subscription-block">
                <div class="subscription-block__wrapper flex flex-col justify-between items-center">
                    ...
                    <div class="sub-item font-sans font-thin tracking-tight text-xs sm:text-sm md:text-sm lg:text-base xl:text-xl w-full md:w-4/6">
                        <div class="sub-item__wrapper flex flex-col md:flex-row justify-between h-full">
                            <ul class="list basis-[30%] h-full flex flex-col mb-[5%] md:mb-0">
                                <li>
                                    <span>
                                        Personal manager
                                    </span>
                            ...
                            <div class="feedback basis-[70%] h-full border p-4 md:mb-[7%]">
                                <div class="bg-white h-full flex flex-col sm:flex-row justify-between p-4">
                                    ...
                                    <div class="btn basis-[45%] w-full pt-4 sm:pt-0">
                                        <ButtonDarkGray button-name="send"></ButtonDarkGray>
                                    </div>
                                </div>
                            </div>
                        </div>
