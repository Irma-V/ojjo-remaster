<template>
    <section ref="vSelect" class="min-[375px]:basis-1/2 min-[769px]:basis-1/3 xl:basis-[15%] p-[2%]">
        <div class="v-select relative w-full 
            ...
            <div v-if="isVisiable"
                class="v-select__options p-1 border-solid border-[0.1rem] border-500 absolute bg-white w-full z-50 h-40 overflow-hidden overflow-y-auto">
                <p v-for="option in options" :key="option" class="v-select__option capitalize cursor-pointer m-0"
